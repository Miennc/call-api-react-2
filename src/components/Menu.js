    ...
    <div className="container mx-auto">
        <div>
            ...
            <div className="w-full h-96  overflow-hidden mx-auto mt-2">
                <img src="https://noithatvuonggia.com/wp-content/uploads/2018/08/banner-moi-nhat-noi-that-do-go-da-nang-021.jpg" alt=""  className="object-cover w-full h-full"/>
            </div>
            ...
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod <br></br> tempor incididunt ut laboresed do eiusmod tempor incididunt ut  labore et dolore magna aliqua".
            </div>
        </div>
    </div>
  )
